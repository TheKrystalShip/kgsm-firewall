...
#
# The version is declared in exactly ONE place — src/Firewall/Firewall.csproj — and read from there, so the package,
# the binary and the changelog can never disagree about what this is.
#
# The DAEMON's version. Firewall.Contracts is a separately-published NuGet and versions on its own
...
SOURCE_FILE="${HERE}/../src/Firewall/Firewall.csproj"
